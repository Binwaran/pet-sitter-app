...
export default function BookingThankYouPage() {
  ...
  // mock data สำหรับ demo UI (ควรดึงจาก backend จริงใน production)
  const mockBooking = {
    transactionDate: 'Tue, 16 Oct 2022',
    transactionNo: '122312',
    sitter: 'Happy House! By Jane Maison',
    date: '25 Aug, 2023',
    time: '7 AM - 10 AM',
    duration: '3 hours',
    pets: 'Bubba, Daisy',
    total: '900.00',
    mapUrl: '/assets/mock/map.png',
  };

  // Use booking from localStorage if available, fallback to mockBooking
